        ...
        <div>
            <button id='edit-${uuid}'>
                <div class='icon-container'>
                    <img width='24' height='24' src='./images/pencil-icon.png'/>
                    <p class='edit-text'>Edit</p>
                </div>
            </button>
            <button id='delete-${uuid}'>
                <div class='icon-container'>
                    <img width='24' height='24' src='./images/trash-icon.png'/>
...
const generateEditDialog = (uuid) => {
    ...
    editDialog.innerHTML = `
        <form method='dialog'>
            ...
            <div>
                <button class='dialog-button' id='save-edit-${uuid}'>Save</button>
